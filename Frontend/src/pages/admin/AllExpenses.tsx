...
const AllExpenses = () => {
  ...
  useEffect(() => {
    ...
    fetchCategories();
    fetchUsers();
  }, [currentPage, statusFilter, categoryFilter, userFilter]);
        ...
        <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
          <div>
            ...
            <p className="mt-1 text-muted-foreground">
              Company-wide expense overview for {company?.name}
            </p>
          </div>
          <Button onClick={exportReport} className="bg-gradient-accent">
          ...
          <Card className="p-4">
            <div className="flex flex-col gap-4 md:flex-row md:items-center">
              <div className="relative flex-1">
                ...
                <Input
                  placeholder="Search expenses, merchants, or employees..."
                  value={searchTerm}
                        ...
                        <div className="text-right">
                          ...
                          <div className="mt-1 max-w-48">
                            {expense.approvals.map((approval, idx) => (
                              <div key={approval.id} className="text-xs truncate">
